...
const CreateNewsPage = () => {
  ...
  const handleInputChange = (
    ...
    setFormData((prev) => {
      ...
      if (keys.length === 3) {
        // Handles meta.title.en, meta.description.kh, etc.
        const [field, subfield, lang] = keys;
  
        if (
          field in updated &&
          typeof updated[field as keyof FormData] === "object" &&
          updated[field as keyof FormData] !== null
        ) {
          const nestedField = updated[field as keyof FormData] as any;
  
          if (subfield in nestedField && typeof nestedField[subfield] === "object") {
            nestedField[subfield][lang] = value;
          }
        }
  
      } else if (keys.length === 2) {
        // Handles title.en, description.kh, etc.
        ...
        if (
          ...
          const localizedField = updated[field as keyof FormData] as any;
          localizedField[lang] = value;
        }
  
      } else if (keys.length === 1) {
        // Handles category, tags, status, etc.
        const key = keys[0] as keyof FormData;
  
        if (key in updated) {
          (updated[key] as any) = value;
        }
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const articleTitle = formData.title.en
      const status = formData.status === "published" ? "published" : "saved as draft"
      toast.success(`News article "${articleTitle}" ${status} successfully!`)
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100">Create News Article</h1>
                <p className="text-slate-600 dark:text-slate-400 mt-1">
                  Create and publish news articles in multiple languages
                </p>
              </div>
                  ...
                  <TabsContent value="content" className="space-y-6">
                    <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                      <CardHeader className="pb-4">
                        ...
                        <CardDescription>Create compelling content in both English and Khmer languages</CardDescription>
                      </CardHeader>
                  ...
                  <TabsContent value="media" className="space-y-6">
                    <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                      <CardHeader>
                        ...
                        <CardDescription>Upload thumbnail and additional images for your article</CardDescription>
                      </CardHeader>
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                          <div className="space-y-2">
                            ...
                            <div className="flex justify-between items-center">
                              <p className="text-xs text-slate-500">{formData.meta.title.en.length}/60 characters</p>
                          ...
                          <div className="space-y-2">
                            ...
                            />
                            <div className="flex justify-between items-center">
                              <p className="text-xs text-slate-500">{formData.meta.title.kh.length}/60 characters</p>
