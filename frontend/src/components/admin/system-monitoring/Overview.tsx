    ...
    <div className="grid gap-3 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
      <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-white/80 backdrop-blur-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 sm:pb-4">
          ...
          <CardTitle className="text-xs sm:text-sm font-semibold text-slate-700">Server</CardTitle>
        </CardHeader>
        <CardContent className="space-y-2 sm:space-y-3">
          ...
          <div className="text-2xs sm:text-xs text-slate-500">Uptime: <span className="font-medium text-slate-700">{metrics.server.uptime}</span></div>
        </CardContent>
      </Card>
      ...
      <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-white/80 backdrop-blur-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 sm:pb-4">
          ...
          <CardTitle className="text-xs sm:text-sm font-semibold text-slate-700">Database</CardTitle>
        </CardHeader>
        <CardContent className="space-y-2 sm:space-y-3">
          ...
          <div className="text-2xs sm:text-xs text-slate-500">Size: <span className="font-medium text-slate-700">{metrics.database.size}</span></div>
        </CardContent>
      </Card>
      ...
      <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-white/80 backdrop-blur-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 sm:pb-4">
          ...
          <CardTitle className="text-xs sm:text-sm font-semibold text-slate-700">Response</CardTitle>
        </CardHeader>
        <CardContent className="space-y-2 sm:space-y-3">
          <div className="text-lg sm:text-2xl font-bold text-slate-900">{metrics.server.responseTime}ms</div>
          <div className="flex items-center text-2xs sm:text-xs text-slate-500">
      ...
      <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-white/80 backdrop-blur-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 sm:pb-4">
          ...
          <CardTitle className="text-xs sm:text-sm font-semibold text-slate-700">Requests/min</CardTitle>
        </CardHeader>
        <CardContent className="space-y-2 sm:space-y-3">
          <div className="text-lg sm:text-2xl font-bold text-slate-900">{metrics.server.requestsPerMinute}</div>
          <div className="text-2xs sm:text-xs text-slate-500">Active traffic</div>
        </CardContent>
      </Card>
    </div>
  );
