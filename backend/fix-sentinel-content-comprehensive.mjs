...
async function fixSentinelContentComprehensive() {
  try {
    await mongoose.connect(process.env.MONGODB_URI);
    console.log('Connected to MongoDB');
    console.log('Starting comprehensive fix for Sentinel content...');
    
    // Find all articles from Sentinel that may have formatting issues
    ...
    console.log(`Found ${articles.length} Sentinel articles with potential formatting issues`);
...
fixSentinelContentComprehensive();
