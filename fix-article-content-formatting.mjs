...
import { cleanContent } from './backend/utils/contentCleaner.mjs';
import { formatContentAdvanced } from './backend/utils/advancedContentFormatter.mjs';
...
async function fixArticles() {
  try {
    ...
    logger.info(`Found ${articles.length} articles that may need content formatting fixes`);
